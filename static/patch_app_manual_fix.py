...
'''
        ...
        if 'if __name__ == "__main__":' in content:
            ...
            print("Inserted /api/place-order endpoint")
        else:
            print("Could not find main block, appending (risky)")
            content += "\n" + new_endpoint

    with open(APP_PATH, "w") as f:
        f.write(content)
    print("Successfully patched app.py with manual order endpoint (fixed)")

if __name__ == "__main__":
    patch_app_manual_fix()

...
# This script forces the Nav Bar into the FKPolySDK templates
TEMPLATE_PATH = "../FKPolySDK/web_front_src/templates/index.html"
...
def patch_template():
    if not os.path.exists(os.path.dirname(TEMPLATE_PATH)):
        print(f"Error: {TEMPLATE_PATH} dir not found")
        return
        
    with open(TEMPLATE_PATH, "w") as f:
        f.write(NEW_TEMPLATE)
    print("Successfully patched FKPolySDK/web_front_src/templates/index.html with Navigation")
